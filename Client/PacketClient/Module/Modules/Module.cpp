...
void IModule::setEnabled(bool enabled) {
	if (this->enabled != enabled) {
		...
		if (enabled) {
			this->onEnable();
			//PlaySoundA((LPCSTR)("C:\\Users\\ggpac\\AppData\\Local\\Packages\\Microsoft.MinecraftUWP_8wekyb3d8bbwe\\RoamingState\\OrionFusion\\Assets\\Sounds\\Enable2.wav"), NULL, SND_FILENAME | SND_ASYNC);
		}
		else {
			//PlaySoundA((LPCSTR)("C:\\Users\\ggpac\\AppData\\Local\\Packages\\Microsoft.MinecraftUWP_8wekyb3d8bbwe\\RoamingState\\OrionFusion\\Assets\\Sounds\\Disable2.wav"), NULL, SND_FILENAME | SND_ASYNC);
			this->onDisable();
		}
