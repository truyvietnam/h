...
void TestModule::onEnable() {
	...
	if (test) {
		//PlaySoundA((LPCSTR)("C:\\Users\\ggpac\\AppData\\Local\\Packages\\Microsoft.MinecraftUWP_8wekyb3d8bbwe\\RoamingState\\OrionFusion\\Assets\\Sounds\\song.wav"), NULL, SND_FILENAME | SND_ASYNC);
		counter = 0;
		sliderX = -5;
	}
	if (test2) { 
	//PlaySoundA((LPCSTR)("C:\\Users\\ggpac\\AppData\\Local\\Packages\\Microsoft.MinecraftUWP_8wekyb3d8bbwe\\RoamingState\\OrionFusion\\Assets\\Sounds\\sound.wav"), NULL, SND_FILENAME | SND_ASYNC);
	}
}
